...
public class SkipConnectGRPC implements E2ECase {
    private final MxBuilder builder;
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;

    public SkipConnectGRPC(MxBuilder builder, Tools.mxgateHelper mxgateHelper) {
    ...
    private MxClient getMxClient(String httpURL, String grpcURL, String schema, String tableName, String delimiter) {
        MxClient client = this.builder.skipConnect(httpURL, grpcURL, schema, tableName, delimiter);
        return client;
    }
