...
public class ConnectWithGroupConfigCallbackGRPC implements E2ECase {
    private final MxBuilder builder;
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;

    public ConnectWithGroupConfigCallbackGRPC(MxBuilder builder, Tools.mxgateHelper mxgateHelper) {
