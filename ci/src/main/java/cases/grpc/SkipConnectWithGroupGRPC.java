...
public class SkipConnectWithGroupGRPC implements E2ECase {
    private final MxBuilder builder;
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;

    public SkipConnectWithGroupGRPC(MxBuilder builder, Tools.mxgateHelper mxgateHelper) {
    ...
    private MxClient getMxClient(String httpURL, String grpcURL, String schema, String tableName, String delimiter) {
        MxClient client = this.builder.skipConnectWithGroup(httpURL, grpcURL, schema, tableName, delimiter, 1);
