...
public class SkipConnectWithGroupConfigGRPC implements E2ECase {
    private final MxBuilder builder;
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;

    public SkipConnectWithGroupConfigGRPC(MxBuilder builder, Tools.mxgateHelper mxgateHelper) {
    ...
    private MxClient getMxClient(String httpURL, String grpcURL, String schema, String tableName, String delimiter) {
        MxClient client = this.builder.skipConnectWithGroup(httpURL, grpcURL, schema, tableName, delimiter, 10, 1000, 3000, 1);
