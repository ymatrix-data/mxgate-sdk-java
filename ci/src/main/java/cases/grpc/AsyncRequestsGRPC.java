...
public class AsyncRequestsGRPC implements E2ECase {
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;
    private final MxBuilder builder;

    public AsyncRequestsGRPC(MxBuilder builder, Tools.mxgateHelper helper) {
    ...
    private void runTestCase() throws Exception {
        ...
        // start mxgate
        try {
            mxgateHelper.startGrpc(dbHelper.getDBName(), schema, tableName1, 1000);
        } catch (Exception e) {
