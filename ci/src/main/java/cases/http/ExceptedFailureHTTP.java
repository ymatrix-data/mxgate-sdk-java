...
public class ExceptedFailureHTTP implements E2ECase {
    ...
    public ExceptedFailureHTTP(MxBuilder builder, Tools.mxgateHelper mxgateHelper) {
    ...
    public void execute() throws AssertionError, IOException, SQLException {
        ...
        builder.connect(httpURL, grpcURL, schema, tableName, new ConnectionListener() {
            @Override
