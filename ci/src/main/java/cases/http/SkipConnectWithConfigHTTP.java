...
public class SkipConnectWithConfigHTTP implements E2ECase {
    private final MxBuilder builder;
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;

    public SkipConnectWithConfigHTTP(MxBuilder builder, Tools.mxgateHelper helper) {
    ...
    private void runTestCase() throws Exception {
        ...
        MxClient client = this.builder.skipConnect(httpURL, grpcURL, schema, tableName1, "|", 10, 1000, 3000);
