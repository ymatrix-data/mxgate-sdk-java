...
public class ConnectWithGroupHTTP implements E2ECase {
    private final MxBuilder builder;
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;

    public ConnectWithGroupHTTP(MxBuilder builder, Tools.mxgateHelper mxgateHelper) {
    ...
    private void runTestCase() throws Exception {
        ...
        MxClient client = this.builder.connectWithGroup(httpURL, grpcURL, schema, tableName1,1);
