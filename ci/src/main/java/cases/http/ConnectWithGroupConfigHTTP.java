...
public class ConnectWithGroupConfigHTTP implements E2ECase {
    private final MxBuilder builder;
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;

    public ConnectWithGroupConfigHTTP(MxBuilder builder, Tools.mxgateHelper helper) {
    ...
    private void runTestCase() throws Exception {
        ...
        MxClient client = this.builder.connectWithGroup(httpURL, grpcURL, schema, tableName1,10, 1000, 3000, 1);
