...
public class SkipConnectWithGroupHTTP implements E2ECase {
    private final MxBuilder builder;
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;

    public SkipConnectWithGroupHTTP(MxBuilder builder, Tools.mxgateHelper mxgateHelper) {
    ...
    private void runTestCase() throws Exception {
        ...
        MxClient client = this.builder.skipConnectWithGroup(httpURL, grpcURL, schema, tableName1, "|", 1);
