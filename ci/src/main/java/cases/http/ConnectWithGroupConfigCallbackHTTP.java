...
public class ConnectWithGroupConfigCallbackHTTP implements E2ECase {
    private final MxBuilder builder;
    private final Tools.mxgateHelper mxgateHelper;
    private final DBHelper dbHelper;

    public ConnectWithGroupConfigCallbackHTTP(MxBuilder builder, Tools.mxgateHelper mxgateHelper) {
    ...
    private void runTestCase() throws Exception {
        ...
        MxClient client = getMxClient(httpURL, grpcURL, schema, tableName1);
    ...
    private MxClient getMxClient(String httpURL, String grpcURL, String schema, String tableName) {
        final MxClient[] clientRet = {null};
        CountDownLatch latch = new CountDownLatch(1);
        this.builder.connectWithGroup(httpURL, grpcURL, schema, tableName, new ConnectionListener() {
            @Override
